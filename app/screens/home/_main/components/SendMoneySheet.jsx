...
//
const DepositCards = ({ depositName, depositDesc, depositImage, screenName }) => {
    //
    const { navigate } = useNavigation();
    //
    const onSelectDeposit = () => {
        navigate(screenName, { depositName, depositDesc });
    }
    //
    return (
        <Pressable onPress={onSelectDeposit} style={styles.depositCon}>
            <Image
                resizeMode="contain"
                source={{ uri: depositImage }}
