        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[SIZES.text_sm, { color: COLORS.font_secondary, textAlign: 'center', fontFamily: "poppins400" }]}>
                    Topup money from different channels
                </Text>
            </View>
            {/* Deposit Cards */}
            <View style={{ rowGap: 10 }}>
                <Cards
                    name="MMT"
                    screenName="MMT"
                    desc="Topup money from different phonepay"
                ...
                <Cards
                    name="Paypal"
                    screenName="Paypal"
                    desc="Topup money from your Paypal account"
                ...
                <Cards
                    screenName="Agent"
                    name="Debit / Credit"
                    desc="Topup money from your master or visa card"
    ...
    return (
        <Pressable onPress={onSelect} style={styles.depositCon}>
            <Image
                resizeMode="contain"
                source={{ uri: image }}
                style={{ width: 90, height: 60, borderWidth: 1, borderRadius: 5, borderColor: COLORS.gray_color }}
            />
            <View style={{ flex: 1 }}>
