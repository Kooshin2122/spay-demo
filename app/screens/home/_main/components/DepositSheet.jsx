    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <View>
                    <Text style={[SIZES.text_xl, { color: COLORS.font_primary, }]}>
                        Deposit
                    </Text>
                    <Text style={[SIZES.text_sm, { color: COLORS.font_secondary, fontFamily: "poppins400", textAlign: "center" }]}>
                        Top up your account from different channels
                    </Text>
                </View>
                {/* <Pressable onPress={onClose}>
                    <Text style={[SIZES.text_base, { color: COLORS.danger_color, fontFamily: "poppins600" }]}>
                        Cancel
                     </Text>
                </Pressable> */}
            </View>
            ...
            <View style={{ rowGap: 10 }}>
                <DepositCards
                    ...
                    depositDesc="Deposit money from your mobile number 6150***96"
                ...
                <DepositCards
                    screenName="Paypal"
                    depositName="Paypal"
                    depositDesc="Take money from your Paypal account"
