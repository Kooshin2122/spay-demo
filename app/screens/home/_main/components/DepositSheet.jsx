        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[SIZES.text_sm, { color: COLORS.font_secondary, textAlign: "center", fontFamily: "poppins400" }]}>
                    Deposit money from different channels
                </Text>
            </View>
            {/* Deposit Cards */}
            <View style={{ rowGap: 10 }}>
                <Cards
                    name="MMT"
                    screenName="MMT"
                    desc="Deposit money from different phonepay"
                ...
                <Cards
                    name="Paypal"
                    screenName="Paypal"
                    desc="Deposit money from your Paypal account"
                ...
                <Cards
                    screenName="Agent"
                    name="Debit / Credit"
                    desc="Deposit money from your master or visa card"
